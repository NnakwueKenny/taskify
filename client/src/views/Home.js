...
const Home = () => {
  ...
  return (
    <div className='flex flex-col items-center h-full w-full max-w-lg text-gray-600'>
        <div className='w-full flex flex-col pb-5 p-4'>
            ...
            <div className='w-full flex items-center rounded-xl bg-gray-100 text-gray-500 p-3'>
        ...
        <div className='h-full w-full overflow-y-auto py-3 pt-3'>
            ...
            <div className='flex flex-col gap-4'>
                <div className='flex justify-between items-center text-sm font-semibold px-3'>
                    ...
                    <Link to='/' className='text-cyan-500'>See All</Link>
                </div>
                <div className='flex gap-4 overflow-x-auto px-4 pb-3'>
                    <div className='shrink-0 h-80 w-full max-w-xs border rounded-xl overflow-hidden'>
                        ...
                        <div className='h-3/5 p-3 pb-6 flex flex-col'>
                            ...
                            <div className='flex flex-col gap-4'>
                                <div className='text-base flex justify-between items-end'>
                                    <div className='h-8 w-20 bg-cyan-500 flex items-center justify-center rounded-xl text-white font-semibold'>60/90</div>
                                    <span>9 days left</span>
                                </div>
                                <div className='w-full rounded bg-gray-200 h-1 overflow-hidden'>
                                    <div className='w-[85%] bg-cyan-500 h-full'></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div className='w-full flex justify-between gap-3 py-3 bg-transparent'>
            <button className='flex flex-col items-center text-cyan-500 hover:text-cyan-600 p-2 px-3'>
                <span className='flex'><i className='fa fa-home'></i></span>
                <span className='text-xs'>Home</span>
            </button>
            <button className='flex flex-col items-center text-gray-300 hover:text-cyan-500 p-2'>
                <span className='flex'><i className="fa fa-bars-progress"></i></span>
                <span className='text-xs'>Project</span>
            </button>
            <button className='w-full max-w-[40px] h-[40px] rounded-full text-white bg-cyan-500 flex flex-col items-center justify-center p-2'>
            ...
            <button className='flex flex-col items-center text-gray-300 hover:text-cyan-500 p-2 px-3'>
