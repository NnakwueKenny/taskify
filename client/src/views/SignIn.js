  ...
  return (
    <div className='flex flex-col justify-between items-center h-full w-full p-3'>
        ...
        <div className='w-full flex justify-center items-center py-1'>
            <h1 className='text-4xl font-semibold text-gray-600'>Login to Your Account</h1>
        </div>

        <form className='w-full max-w-md flex flex-col gap-4 py-2'>
            ...
            <div className='py-2'>
                <button type='button' className='text-white bg-cyan-500 rounded-3xl py-3 font-semibold w-full shadow-md shadow-cyan-100'>Sign in</button>
            </div>
            <div className='text-center text-cyan-500 font-semibold italic'>
        ...
        <div className='py-3 flex justify-center text-gray-700'>
            <p>Don't have an account? <Link to='/sign-up' className='text-cyan-500 font-semibold'>Sign Up</Link></p>
        </div>
    </div>
  )
}
